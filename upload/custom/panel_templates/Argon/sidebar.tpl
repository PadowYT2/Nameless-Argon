    ...
    <div class="container-fluid">
        ...
        <ul class="nav align-items-center d-md-none">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    <a href="{$LOGGED_IN_USER.panel_profile}"
                        class="nav-item dropdown-item">{$LOGGED_IN_USER.nickname}</a>
                </div>
            </li>
        </ul>
        <!-- Collapse -->
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link{if isset($PARENT_PAGE) && $PARENT_PAGE eq $name} active{/if}"
                        href="#dropdown{$i}" data-toggle="collapse" role="button" aria-expanded="true"
                        aria-controls="navbar-examples">
                        {$item.icon}
                        <span class="nav-link-text">{$item.title}</span>
                    </a>
                    <div class="collapse{if isset($PARENT_PAGE) && $PARENT_PAGE eq $name} show{/if}" id="dropdown{$i}">
