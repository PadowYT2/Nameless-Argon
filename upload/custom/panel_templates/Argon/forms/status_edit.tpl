    ...
    <div class="container-fluid mt--8">
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-md-9">
              <p style="margin-top: 7px; margin-bottom: 7px;">{$EDITING_STATUS}</p>
            </div>
            <div class="col-md-3">
          ...
          <form action="" method="post">
            <div class="form-group">
              ...
              <input type="text" name="status_html" placeholder="{$STATUS_HTML}" value="{$STATUS_HTML_VALUE}"
                id="status_html" class="form-control">
            </div>
            <div class="form-group">
              <label for="status_forms">{$STATUS_FORMS}</label>
              <select name="status_forms[]" id="label_forms" size="5" class="form-control" multiple
                style="overflow:auto;">
                {if count($ALL_FORMS)}
            ...
            <div class="form-group">
              ...
              <select name="status_groups[]" id="label_groups" size="5" class="form-control" multiple
                style="overflow:auto;">
                {if count($ALL_GROUPS)}
            ...
            <div class="form-group">
              ...
              <input id="inputOpen" name="open" type="checkbox" class="js-switch" {if $MARKED_AS_OPEN_VALUE eq 1}
                checked{/if} />
            </div>
            <div class="form-group">
