	...
	<div class="card-body">
		...
		<form action="" method="POST">
			...
			<div class="form-group">
				...
				<label for="footer_color">{$NAVBAR_COLOR_LABEL}</label> <span class="badge badge-info"
                                style="margin-right:10px" data-toggle="popover" data-title="{$INFO}"
                                data-content="{$COLORS_INFO_LABEL}" data-html="true"><i
			...
			<div class="form-group">
				...
				<label for="footer_color">{$FOOTER_COLOR_LABEL}</label>  <span class="badge badge-info"
                                style="margin-right:10px" data-toggle="popover" data-title="{$INFO}"
                                data-content="{$COLORS_INFO_LABEL}" data-html="true"><i
                                    class="fas fa-question-circle"></i></span>
