    ...
    <div class="container-fluid mt--8">
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-md-9">
              <h3 style="margin-top: 10px; margin-bottom: 7px;">{$FORUM_TITLE_VALUE}</h3>
            </div>
            <div class="col-md-3">
          ...
          <form role="form" action="" method="post">
            ...
            <div class="form-group">
              ...
              <textarea name="description" id="InputDescription" placeholder="{$FORUM_DESCRIPTION}" class="form-control"
            ...
            <div class="form-group">
              ...
              <input type="text" name="icon" class="form-control" id="InputIcon" placeholder="{$FORUM_ICON}"
                value="{$FORUM_ICON_VALUE}">
            </div>
            ...
            <div class="form-group">
              ...
              <input name="display" id="InputDisplay" value="1" class="js-switch" type="checkbox" {if
            ...
            <div class="form-group">
              ...
              <input name="redirect" id="InputForumRedirect" type="checkbox" class="js-switch" value="1" {if
                $REDIRECT_FORUM_VALUE} checked{/if} />
            </div>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><input type="hidden" name="perm-view_others-0" value="0" /><input onclick="colourUpdate(this);"
                        name="perm-view_others-0" id="Input-view_others-0" value="1" type="checkbox" {if
                        isset($GUEST_PERMISSIONS->view_other_topics) && $GUEST_PERMISSIONS->view_other_topics eq 1}
                      checked{/if} />
                    </td>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><input type="hidden" name="perm-topic-{$group->id|escape}" value="0" /><input
                        ...
                        id="Input-topic-{$group->id|escape}" value="1" type="checkbox" {if isset($group->create_topic)
                      && $group->create_topic eq 1} checked{/if} />
                    </td>
                    ...
                    <td><input type="hidden" name="perm-moderate-{$group->id|escape}" value="0" /><input
                        ...
                        id="Input-moderate-{$group->id|escape}" value="1" type="checkbox" {if isset($group->moderate) &&
                      $group->moderate eq 1} checked{/if} />
                    </td>
                  </tr>
                  <script>
