            ...
            <div class="card">
                <div class="card-body">
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-9">
                            <h3 style="margin-top: 10px; margin-bottom: 7px;">{$CREATING_COUPON}</h3>
                        </div>
                        <div class="col-md-3">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group" id="effectiveOnPackages">
                            ...
                            <select class="form-control" id="inputEffectiveOnPackages" name="packages[]" multiple>
                                ...
                                <option value="{$available_package->id|escape}">{$available_package->name|escape}
                                </option>
                                {/foreach}
                                {/if}
                            </select>
                        ...
                        <div class="form-group" id="effectiveOnCategories">
                            ...
                            <select class="form-control" id="inputEffectiveOnCategories" name="categories[]" multiple>
                                ...
                                <option value="{$available_category->id|escape}">{$available_category->name|escape}
                                </option>
                                {/foreach}
                                {/if}
                            </select>
                                ...
                                <div class="form-group" id="discountTypePercentage">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" name="discount_percentage"
                                            id="inputDiscountTypePercentage" placeholder="{$DISCOUNT_TYPE_PERCENTAGE}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="basket_type" id="inputBasketType">
                                <option value="both" {if $BASKET_TYPE_VALUE eq 'both' } selected{/if}>{$ALL_PURCHASES}
                                </option>
                                <option value="single" {if $BASKET_TYPE_VALUE eq 'single' } selected{/if}>
                                    {$ONE_OFF_PURCHASES}</option>
                                <option value="subscription" {if $BASKET_TYPE_VALUE eq 'subscription' } selected{/if}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="discount_application_method"
                                ...
                                <option value="1" {if $DISCOUNT_APPLICATION_TYPE_VALUE eq '1' } selected{/if}>
                                    {$EACH_PACKAGE}</option>
                                <option value="2" {if $DISCOUNT_APPLICATION_TYPE_VALUE eq '2' } selected{/if}>
                                    {$BASKET_BEFORE_SALES}</option>
                                <option value="3" {if $DISCOUNT_APPLICATION_TYPE_VALUE eq '3' } selected{/if}>
                                    {$BASKET_AFTER_SALES}</option>
                            </select>
                        </div>
