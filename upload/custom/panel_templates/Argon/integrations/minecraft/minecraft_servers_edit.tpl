        ...
        <div class="container-fluid mt--8">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            <h3 style="margin-top: 10px; margin-bottom: 7px;">{$EDITING_SERVER}</h3>
                        </div>
                        <div class="col-md-3">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select id="InputParentServer" class="form-control" name="parent_server">
                                ...
                                <option value="{$available_server->id|escape}" {if $PARENT_SERVER_VALUE eq
                                    $available_server->id} selected{/if}>{$available_server->name|escape}</option>
                                {/if}
                                {/foreach}
                                {/if}
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputPre17" name="pre_17" type="checkbox" class="js-switch" value="1" {if
                                $PRE_17_VALUE} checked{/if} />
                        </div>
