...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container-fluid mt--8">
            ...
            <div class="card">
                <div class="card-body">
                    <a href="{$NEW_CATAGORY_LINK}" class="btn btn-info">{$NEW_CATAGORY}</a>
                    <hr />
                    ...
                    {/if}
                    <hr>
                    <a href="{$NEW_BUTTON_LINK}" class="btn btn-info">{$NEW_BUTTON}</a>
                    <hr />
        ...
        <div class="modal fade" id="deleteButtonModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">{$NO}</button>
                        <a href="#" id="deleteButtonLink" class="btn btn-info">{$YES}</a>
                    </div>
                </div>
            </div>
        </div>
